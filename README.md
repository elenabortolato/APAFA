...
To reproduce the results of Section 3, go to URLSIMULATIONS. To reproduce the results of the real data analisis of Section 4, go to URLIMMUNE or URLBIRDS. 
