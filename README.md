...
To reproduce the results of the real data analysis of Section 4 of the paper, go to the [Birds workflow](Real_Data/birdsmd.md) or the [Immune workflow](Real_Data/Immune_WF.md) in the [Real_Data](Real_data) folder. 
