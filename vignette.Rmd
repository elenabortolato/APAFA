...
Start by loading the file sampler.R that contains the main Gibbs sampler method and all library dependencies
...
Show the running loglikelihood and the number of active factors
...
The figure below shows the posterior distribution of the entries of the covariance matrix compared with true values (red marks)
