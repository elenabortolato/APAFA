...
We order the elements of such covariance matrix by the type of birds, in particular considering the migration type behavior

```{r}
ordercov <- 50*as.numeric(as.factor(TrData_taxonomy$Migration=="R"))+
...
#long purple, mid blue
col2=ifelse(col==1, "purple", "blue")
#short red
col2=ifelse(col==3,"red", col2)
heatmap((GG[ordercov,ordercov]),  Rowv = NA, Colv=NA,symm = T, col=cm.colors(80),
        RowSideColors = col2[ordercov],
        labRow = TrData_taxonomy$Species[ordercov],
        labCol = TrData_taxonomy$label[ordercov],
