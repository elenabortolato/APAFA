...
We set prior hyperparameters as
...
plot(colMeans(ris_phi[5000:10000,,1])~da[,6],
                    xlab=colnames(da)[6],ylab=expression(varphi[1]))
```
...
We show the posterior mean of the factors ordering by latitude and habitat
```{r}
...
We also display  lower and upper  bounds of credible intervals (10% and 90%) for specific factors ordering, again, by latitude.
