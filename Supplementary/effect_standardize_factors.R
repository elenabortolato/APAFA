#SUPPLEMENTARY S1: standardizing the loadings vs non standardizing
library(Rcpp) 
library(MASS)
library(mvtnorm)
library(MCMCpack)
...
matplot(ris_lambda1, type="l", main=expression(lambda[1]))
matplot(ris_lambda2, type="l", main=expression(lambda[2]))
matplot(ris_lambda3, type="l", main=expression(lambda[3]))
matplot(ris_lambda4, type="l", main=expression(lambda[4]))


matplot(ris_gamma1, type="l", main=expression(gamma[1]))
matplot(ris_gamma2, type="l", main=expression(gamma[2]))
matplot(ris_gamma3, type="l", main=expression(gamma[3]))
matplot(ris_gamma4, type="l", main=expression(gamma[4]))
